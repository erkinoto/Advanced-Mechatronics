...
void LCDprint(char *message, unsigned short x, unsigned short y, unsigned c1, unsigned c2) {
    unsigned short k = 0;
        while(message[k]){
...
void Xbar(unsigned short x, unsigned short y, unsigned short length, signed short Ax, unsigned c1, unsigned c2) {
...
void Ybar(unsigned short x, unsigned short y, unsigned short length, signed short Ay, unsigned c1, unsigned c2) {
    unsigned short m = 0, n = 0, l = 0, neg =0;
    for (n=0; n<=length; n++) {
        for (m=0; m<7; m++) {  //height
