...
int main() {
   ...
   __builtin_mtc0(_CP0_CONFIG, _CP0_CONFIG_SELECT, 0xa4210583);
    ...
    int i;
    float FPS;
    //LCD_drawPixel(120,160,ILI9341_GREEN);
 ...
 for(i=0;i<=100;i++){
		    ...
		    LCD_drawString(28,32,message,ILI9341_WHITE );
            LCD_drawBar(14,48,i,ILI9341_RED);

            FPS = 24000000/_CP0_GET_COUNT(); //FPS
            sprintf(message,"FPS: %1.2f",FPS);
            LCD_drawString(14,80,message,ILI9341_WHITE );
