...
void APP_Tasks(void) {
    ...
    //Read LCM at 20 Hz
        ...
        print2LCD(message, x, y+50, ILI9341_BLUE, ILI9341_PURPLE);
        sprintf(message, "gY = %6d  ", gY);
        print2LCD(message, x, y+60, ILI9341_BLUE, ILI9341_PURPLE);
        sprintf(message, "gZ = %6d  ", gZ);
        print2LCD(message, x, y+70, ILI9341_BLUE, ILI9341_PURPLE);
        sprintf(message, "aX = %6d  ", aX);
        print2LCD(message, x+80, y+50, ILI9341_BLUE, ILI9341_PURPLE);
        sprintf(message, "aY = %6d  ", aY);
        print2LCD(message, x+80, y+60, ILI9341_BLUE, ILI9341_PURPLE);
        sprintf(message, "aZ = %6d  ", aZ);
        print2LCD(message, x+80, y+70, ILI9341_BLUE, ILI9341_PURPLE);
